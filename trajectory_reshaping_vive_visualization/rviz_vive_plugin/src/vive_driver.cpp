...
bool VRSettings::GetBool(const char* pchSection,const char* pchSettingsKey,vr::EVRSettingsError* peError)
{
    ...
    else if(strcmp(pchSettingsKey, "directMode")) return false;
    else if(strcmp(pchSettingsKey, "directModeEdidVid")) return false;
    else if(strcmp(pchSettingsKey, "directModeEdidPid")) return false;
	return 0;
}
