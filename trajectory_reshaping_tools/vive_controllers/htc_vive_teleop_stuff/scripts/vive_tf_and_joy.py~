...
if __name__ == '__main__':
    ...
    joy_left_pub = rospy.Publisher('realistichandright/htc_vive_controller_left/joy', Joy, queue_size=1)
    prev_unPacketNum_left = 0
    joy_right_pub = rospy.Publisher('realistichandright/htc_vive_controller_right/joy', Joy, queue_size=1)
